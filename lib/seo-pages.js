    ...
    sections: [
      {
        ...
        body: 'Many useful AI systems start as private scripts, hosted apps, notebooks, or internal tools. Registration turns that capability into something CAIt can route, verify, call, and hand context to from a leader-run workflow.'
      },
      {
...
export const newsPosts = [
  {
    ...
    date: '2026-05-01',
    kind: 'Product Update',
    title: 'Leader-led chat workspace replaced the old Work UI',
    description: 'CAIt moved the primary work surface into a chat-first workspace where leaders, workers, apps, blockers, and delivery updates are handled in one conversation.',
    keywords: ['CAIt chat workspace', 'AI agent orchestration UI', 'leader-led AI agents', 'AI agent work chat'],
    sections: [
      {
        heading: 'What changed',
        body: 'The old Work tab and the separate chatux test route were consolidated into the main chat workspace. Users now start from chat, review the order inside chat, dispatch from chat, and receive progress plus delivery in the same surface.'
      },
      {
  ...
  },
  {
    ...
    date: '2026-05-01',
    kind: 'Field Note',
    title: 'CMO orchestration now carries research, blockers, and approval gates',
    ...
    keywords: ['CMO AI agent', 'source-backed research', 'AI agent blockers', 'multi-agent marketing workflow'],
    sections: [
      {
        heading: 'What changed',
      ...
      {
        heading: 'Approval and blocker behavior',
        body: 'Action agents must show connector status and approval requirements before claiming external execution. A summary is not the same as a connector action; posting, sending, publishing, and submission still require proof or a visible blocker.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: 'Why this matters',
        body: 'Agent work often includes summaries, files, source tables, blockers, connector states, and action packets. A narrow chat column made those outputs harder to inspect, especially after a multi-agent run.'
      },
      {
  ...
  },
  {
    ...
    date: '2026-05-01',
    kind: 'Field Note',
    title: 'Order progress now treats blockers as visible workflow state',
    ...
    keywords: ['AI agent order status', 'worker blocker state', 'CAIt orchestration', 'agent progress visibility'],
    sections: [
      {
        heading: 'What changed',
        body: 'Order progress is being shaped around explicit states such as intake, running, blocked, waiting for approval, connector required, and delivered. A blocked state should explain whether the system is waiting for the user, a connector, or a worker recovery path.'
      },
      {
        heading: 'Why this matters',
...
export const glossaryCategories = [
  ...
  },
  {
    ...
    terms: [
      ...
      ['Month-End Billing', 'month-end-billing', 'Saved-card billing model where AIagent2 records settled order usage and charges after the billing period.'],
