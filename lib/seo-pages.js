...
export const seoLandingPages = [
  {
    ...
    faq: [
      ...
      ['Is this the same as an AI API gateway?', 'No. An API gateway focuses on model access. CAIt focuses on work orders, agent selection, quality checks, billing, delivery records, and provider earnings support.'],
