...
const BUILT_IN_KIND_DEFAULTS = {
  ...
  research: {
    ...
    systemPrompt: [
      ...
      'Return commercially useful research output.',
    ...
    deliverableHint: 'Write sections for assumptions, analysis, options, recommendation, risks, and next step.',
    reviewHint: 'Tighten weak comparisons, remove generic filler, and make the recommendation decision-ready.'
  },
  writer: {
    fileName: 'writer-delivery.md',
    healthService: 'writing_agent',
    modelRole: 'writing, landing page, and SEO copy',
    systemPrompt: [
      'You are the built-in writing agent for AIagent2.',
      'Return useful copywriting output with concrete structure.',
      'Focus on headline quality, angle, clarity, and conversion.',
      'If SEO is implied, include search-intent-aware copy.',
      'If the task is underspecified, state assumptions briefly and continue.'
    ].join(' '),
    deliverableHint: 'Write sections for audience, offer angle, headline options, supporting copy, CTA, and revision notes.',
    reviewHint: 'Remove bland phrasing, sharpen the angle, and keep the copy easy to scan.'
  },
  code: {
  ...
  cmo_leader: {
    ...
    deliverableHint: 'Write sections for marketing objective, research and evidence first pass, ICP, competitor and channel diagnosis, positioning, chosen media and why, lane decision memo, action decisions, specialist dispatch packets, leader approval queue, connector or execution handoff queue, planned action table, metrics, risks, and next action.',
    reviewHint: 'Remove generic marketing advice, sharpen the target segment, make the measurement plan concrete, ensure execution authority stays with the leader rather than the specialists, and make the chosen lane, approval queue, dispatch packets, and planned action table explicit.'
  },
  cto_leader: {
    ...
    deliverableHint: 'Write sections for technical objective, research/architecture analysis first pass, architecture decision, work split, risks, security notes, validation, rollout, and next action.',
    reviewHint: 'Make technical tradeoffs explicit, avoid vague architecture language, and ensure validation can be executed.'
  },
  cpo_leader: {
  ...
  diligence: {
    ...
    systemPrompt: [
      ...
      'Return a concise diligence memo with clear red flags and follow-up questions.',
      'Focus on unknowns, downside, evidence quality, and what needs verification next.'
    ].join(' '),
    deliverableHint: 'Write sections for scope, positives, red flags, open questions, diligence priorities, and next step.',
    reviewHint: 'Make the risks explicit and the follow-up questions sharper.'
  }
};
...
const BUILT_IN_RESULT_SCHEMA = {
  ...
  required: ['summary', 'report_summary', 'bullets', 'next_action', 'file_markdown', 'confidence']
};
...
const BUILT_IN_KIND_EXECUTION_FOCUS = Object.freeze({
  ...
  writer: 'Create usable copy, not advice about copy. Include audience, angle, options, CTA, and what context would improve the next revision.',
  ...
  cto_leader: 'Make architecture and execution tradeoffs explicit. Include security, operations, validation, rollout, and what access is needed.',
...
const BUILT_IN_KIND_OUTPUT_SECTIONS = Object.freeze({
  ...
  research: ['Answer first', 'Assumptions', 'Evidence and source status', 'Comparison or options', 'Recommendation', 'Risks', 'Next action'],
  ...
  writer: ['Audience', 'Offer angle', 'Copy options', 'Recommended version', 'CTA', 'Revision notes'],
  ...
  growth: ['Answer-first recommendation', 'Current bottleneck', 'ICP and offer', 'Channel priority', '7-day experiment', 'Metrics', 'Stop rules', 'Next action'],
  ...
  cto_leader: ['Technical objective', 'Architecture analysis first pass', 'Architecture decision', 'Access and constraints', 'Security and ops risks', 'Engineering split', 'Validation', 'Rollout'],
  ...
  diligence: ['Scope', 'Positives', 'Red flags', 'Unknowns', 'Evidence quality', 'Diligence priorities', 'Decision blocker'],
...
const BUILT_IN_KIND_INPUT_NEEDS = Object.freeze({
  ...
  writer: ['Audience', 'Offer or product', 'Tone or brand voice', 'Distribution channel', 'CTA'],
  ...
  cto_leader: ['System or repo', 'Architecture goal', 'Constraints', 'Security and ops requirements', 'Validation path'],
  ...
  diligence: ['Target company or product', 'Decision type', 'Evidence available', 'Risk categories', 'Deadline'],
...
const BUILT_IN_KIND_ACCEPTANCE_CHECKS = Object.freeze({
  ...
  writer: ['Copy fits the named audience and channel', 'CTA is explicit', 'Options are meaningfully different', 'Revision notes explain tradeoffs'],
  ...
  cto_leader: ['System and risk analysis happens before implementation split', 'Architecture tradeoff is stated', 'Security and ops risks are included', 'Engineering split is actionable', 'Validation and rollout are clear'],
  ...
  diligence: ['Red flags are prioritized', 'Evidence quality is graded', 'Unknowns are explicit', 'Decision blocker is clear'],
...
const BUILT_IN_KIND_FIRST_MOVES = Object.freeze({
  ...
  writer: 'Lock audience, channel, offer, and CTA before drafting. Produce options that differ by strategic angle rather than superficial wording.',
  ...
  cto_leader: 'Analyze the current system, architecture decision, constraints, security and ops risks, validation path, and rollout shape before recommending implementation.',
  ...
  diligence: 'Clarify the target, decision type, evidence quality, red-flag categories, and decision deadline before summarizing positives.',
...
const BUILT_IN_KIND_FAILURE_MODES = Object.freeze({
  ...
  writer: ['Do not produce generic marketing copy detached from channel and audience', 'Do not offer near-duplicate variants', 'Do not omit CTA or revision rationale'],
  ...
  cto_leader: ['Do not recommend architecture without constraints', 'Do not ignore security, ops, rollout, or validation', 'Do not hide tradeoffs'],
  ...
  diligence: ['Do not summarize positives before red flags', 'Do not hide evidence gaps', 'Do not omit decision blockers'],
...
const BUILT_IN_KIND_EVIDENCE_POLICIES = Object.freeze({
  ...
  writer: 'Ground copy in the supplied audience, offer, proof, and channel. If examples are used, state whether they are supplied examples, comparable patterns, or assumptions.',
  ...
  diligence: 'Use product/company documents, public records, customer signals, financial/technical/legal evidence, and evidence-quality grades.',
...
const BUILT_IN_KIND_NEXT_ACTIONS = Object.freeze({
  ...
  writer: 'End with the recommended copy option, where to publish it, and the first revision test.',
  ...
  cto_leader: 'End with the recommended technical path, validation step, security/ops check, rollout step, and rollback trigger.',
  ...
  diligence: 'End with the top red flags, decision blocker, verification checklist, and go/no-go next step.',
...
const BUILT_IN_KIND_CONFIDENCE_RUBRICS = Object.freeze({
  ...
  writer: 'High when audience, channel, offer, proof, and CTA are supplied; medium when tone or proof is inferred; low when the audience or conversion action is unclear.',
  ...
  diligence: 'High when target, decision, evidence, risk categories, and deadline are clear; medium when evidence quality is mixed; low when target or decision type is undefined.',
...
const BUILT_IN_KIND_HANDOFF_ARTIFACTS = Object.freeze({
  ...
  writer: ['Recommended copy option', 'Alternative angles', 'CTA and channel notes', 'Revision test'],
  ...
  growth: ['Bottleneck diagnosis', '7-day experiment', 'Metrics and stop rules', 'Owner/next action'],
  ...
  cto_leader: ['Architecture decision', 'Security/ops risks', 'Engineering split', 'Rollout validation'],
  ...
  diligence: ['Red flags', 'Evidence quality map', 'Unknowns', 'Go/no-go checklist'],
...
const BUILT_IN_KIND_PRIORITIZATION_RUBRICS = Object.freeze({
  ...
  writer: 'Prioritize copy by audience fit, conversion clarity, proof strength, channel fit, and speed to publish.',
  ...
  diligence: 'Prioritize findings by downside severity, evidence quality, reversibility, decision impact, and verification effort.',
...
const BUILT_IN_KIND_MEASUREMENT_SIGNALS = Object.freeze({
  ...
  writer: ['CTR or open rate', 'Reply/conversion rate', 'CTA clarity', 'Revision delta'],
  ...
  diligence: ['Red-flag closure', 'Evidence quality', 'Decision confidence', 'Verification completion'],
...
const BUILT_IN_KIND_ASSUMPTION_POLICIES = Object.freeze({
  ...
  writer: 'Assume the user wants publishable copy for the stated channel. If audience, tone, or CTA is missing, use a conservative default and label it.',
  ...
  diligence: 'Assume a preliminary risk review. Do not assume access to private data or that unknowns are benign.',
...
const BUILT_IN_KIND_ESCALATION_TRIGGERS = Object.freeze({
  ...
  writer: ['The claim requires proof the user did not provide', 'Audience or channel is unclear', 'Compliance-sensitive copy is requested'],
  ...
  diligence: ['Decision type is unclear', 'Evidence quality is too weak for a recommendation', 'Material legal, financial, or security risk appears'],
...
const BUILT_IN_KIND_MINIMUM_QUESTIONS = Object.freeze({
  ...
  writer: ['Who is the audience and where will this be published?', 'What offer, proof, and CTA must be included?', 'What tone or examples should it match?'],
  ...
  diligence: ['What target and decision type are being reviewed?', 'What evidence is available?', 'Which risk categories matter most?'],
...
const BUILT_IN_KIND_REVIEW_CHECKS = Object.freeze({
  ...
  writer: ['Audience/channel fit is clear', 'CTA is explicit', 'Variants differ strategically'],
  ...
  diligence: ['Red flags are prioritized', 'Evidence quality is graded', 'Decision blocker is visible'],
...
const BUILT_IN_KIND_DEPTH_POLICIES = Object.freeze({
  ...
  writer: 'Default to a small set of publishable options. Go deeper when channel strategy, audience segmentation, or proof architecture is unclear.',
  ...
  diligence: 'Default to top red flags and decision blocker. Go deeper when evidence quality, unknowns, and verification priorities need grading.',
...
const BUILT_IN_KIND_CONCISION_RULES = Object.freeze({
  ...
  writer: 'Avoid explaining basic copywriting theory; deliver usable copy and concise rationale.',
  ...
  diligence: 'Avoid exhaustive summaries; prioritize red flags, evidence quality, unknowns, and decision blocker.',
...
const BUILT_IN_KIND_TOOL_STRATEGIES = Object.freeze({
  ...
  writer: {
    ...
    source_mode: 'provided_brand_context_and_comparable_copy',
    note: 'Use supplied brand, audience, and proof first; browse only when current examples, competitor copy, or factual claims affect the copy.'
  },
  code: {
    web_search: 'when_current',
  ...
  build_team_leader: {
    ...
    note: 'Use repo and GitHub context first; browse only for current platform, SDK, or dependency behavior that affects implementation.'
  },
  cmo_leader: {
    web_search: 'default',
  ...
  cto_leader: {
    ...
    note: 'Prefer supplied architecture, repo, and runtime evidence; use current docs when platform or dependency behavior matters.'
  },
  cpo_leader: {
    web_search: 'when_current',
    source_mode: 'user_evidence_competitors_benchmarks_and_product_signals',
    note: 'Use user evidence first, then current competitor and benchmark signals when they change prioritization.'
  },
  cfo_leader: {
    web_search: 'default',
  ...
  diligence: {
    web_search: 'default',
    source_mode: 'current_company_market_reputation_and_evidence_scan',
    note: 'Use current public evidence, reputation signals, filings, product pages, and customer/market signals for red flags.'
  },
  earnings: {
    web_search: 'default',
...
const BUILT_IN_KIND_SPECIALIST_METHODS = Object.freeze({
  ...
  writer: [
    'Map audience, channel, offer, proof, voice, and CTA before drafting.',
    'Compare against supplied or current examples when claims or channel norms matter.',
    'Deliver publishable copy options, explain the chosen angle briefly, and name the first revision test.'
  ],
  code: [
  ...
  cto_leader: [
    'Clarify system context, constraints, security, reliability, operations, and success criteria.',
    'Compare technical paths by risk, reversibility, validation, cost, and operational burden.',
    'Recommend rollout, validation, monitoring, and rollback steps before implementation.'
  ],
  cpo_leader: [
  ...
  diligence: [
    'Define target, decision type, risk categories, available evidence, and deadline.',
    'Grade evidence quality across product, market, financial, technical, legal, and reputation signals.',
    'Prioritize red flags, unknowns, verification work, and go/no-go blocker.'
  ],
  earnings: [
...
const BUILT_IN_KIND_SCOPE_BOUNDARIES = Object.freeze({
  ...
  writer: [
    ...
    'Do not optimize for cleverness over channel fit, audience clarity, and CTA.',
  ...
  cto_leader: [
    ...
    'Do not over-engineer when a smaller reversible implementation would answer the risk.'
  ],
  cpo_leader: [
  ...
  diligence: [
    ...
    'Do not ignore legal, financial, security, reputation, or operational red flags.',
    'Do not treat unknowns as benign without verification priority.'
  ],
  earnings: [
...
const BUILT_IN_KIND_FRESHNESS_POLICIES = Object.freeze({
  ...
  diligence: 'Treat public records, reputation signals, customer evidence, filings, security posture, and market data as time-sensitive. Date findings and stale unknowns.',
...
const BUILT_IN_KIND_SENSITIVE_DATA_POLICIES = Object.freeze({
  ...
  diligence: 'Treat diligence materials, deal terms, security findings, financials, customer lists, and legal issues as confidential. Grade and summarize evidence without leaking raw sensitive docs.',
...
const BUILT_IN_KIND_COST_CONTROL_POLICIES = Object.freeze({
  ...
  diligence: 'Prioritize red flags, evidence quality, and decision blockers. Avoid exhaustive diligence summaries when a few unknowns determine go/no-go.',
...
function leaderActionProtocolInstruction(body = {}, kind = '') {
  ...
  if (isLeader && phase === 'checkpoint') {
    return `Leader checkpoint phase: use completed layer-1 evidence to choose the next executable lane. Do not restart broad research. Follow input._broker.workflow.leaderActionProtocol version ${String(protocol.version || 'v1')}. Every approved next action must include: ${requiredFields.join(', ') || 'owner, objective, artifact, trigger/timing, metric, stop_rule, approval_owner'}.`;
  }
  if (isLeader) {
...
function googleSourceGroupForCapability(capability = '') {
  ...
  if (normalized === 'google.read_calendar') return 'calendar';
...
function authorityRequestInstruction(kind = '') {
  ...
  return [
    ...
    'If no external authority or source selection is needed, omit authority_request entirely.',
...
function agentPreflightInstruction(body = {}, kind = '') {
  ...
  return [
    ...
    authorityRequest
      ...
      : 'No connector blocker is currently known from preflight; omit authority_request unless the task still needs a specific source selection to continue.'
  ].filter(Boolean).join(' ');
}
...
- If checkout_started is high but paid_order_completed is low: payment/deposit framing, expected delivery, or billing friction.
  ...
  const map = {
    ...
    research: {
      ...
      report: {
        ...
        bullets: [
          isJapanese ? '市場比較の要点を抽出' : 'Extract the key comparison points.',
          isJapanese ? '価格帯と候補を整理' : 'Organize price bands and likely options.',
          isJapanese ? '次アクションを提案' : 'Recommend the next concrete action.'
        ],
        nextAction: isJapanese ? '必要なら詳細比較表に展開' : 'Expand this into a detailed comparison table if needed.'
      },
      usage: { total_cost_basis: 72, compute_cost: 20, tool_cost: 12, labor_cost: 40, api_cost: 0 },
      markdown: isJapanese
        ? `# research delivery\n\n${fallbackPrompt}\n\n- 市場比較の要点を抽出\n- 価格帯と候補を整理\n- 次アクションを提案`
        : `# research delivery\n\n${fallbackPrompt}\n\n- Extract the key comparison points\n- Organize price bands and likely options\n- Recommend the next concrete action`
    },
    equity: {
    ...
    writer: {
      ...
      report: {
        ...
        headline: isJapanese ? 'まず試すべき3つの訴求' : 'Three angles worth testing first',
        bullets: [
          isJapanese ? 'ベネフィット先出し' : 'Lead with the clearest benefit.',
          isJapanese ? '不安解消を中盤に配置' : 'Handle objections in the middle of the copy.',
          isJapanese ? 'CTAを最後に明確化' : 'Make the CTA unambiguous at the end.'
        ]
      },
      usage: { total_cost_basis: 64, labor_cost: 38, compute_cost: 16, tool_cost: 10, api_cost: 0 },
      markdown: isJapanese
        ? `# writer delivery\n\n${fallbackPrompt}\n\n## Headline\nまず試すべき3つの訴求\n\n- ベネフィット先出し\n- 不安解消を中盤に配置\n- CTAを最後に明確化`
        : `# writer delivery\n\n${fallbackPrompt}\n\n## Headline\nThree angles worth testing first\n\n- Lead with the clearest benefit\n- Handle objections in the middle of the copy\n- Make the CTA unambiguous at the end`
    },
    code: {
...
List import, sending, scheduling, and replying only happen after explicit connector approval. In a leader workflow, always return the Leader handoff packet for mediation first.`
    ...
    cmo_leader: {
      summary: isJapanese ? `CMO観点の計画を用意しました: ${fallbackPrompt}` : `CMO plan ready: ${fallbackPrompt}`,
      report: {
        summary: isJapanese ? 'CMO Team Leader結果' : 'CMO Team Leader delivery',
        bullets: [
          isJapanese ? '調査結果を先に集め、その後で媒体と訴求を決める' : 'Collect research findings first, then decide media and positioning.',
          isJapanese ? 'どの specialist を次に動かすかを leader 自身が決める' : 'Let the leader itself decide which specialists move next.',
          isJapanese ? 'leader が承認・実行だけでなく approval queue と planned action table も持つ' : 'Give the leader an approval queue and planned action table, not only an approval path.',
          isJapanese ? '成功指標と止める条件を明示' : 'Set success metrics and stop criteria.'
        ],
        nextAction: isJapanese ? '調査結果から最初の媒体を1つ決め、その媒体の specialist にだけ次の実行依頼を出してください。' : 'Use the research findings to pick one first media lane, then dispatch only that specialist next.'
      },
      usage: { total_cost_basis: 86, compute_cost: 24, tool_cost: 14, labor_cost: 48, api_cost: 0 },
      markdown: isJapanese
        ? `# cmo team leader delivery\n\n${fallbackPrompt}\n\n## CMO判断\n誰に、何を、なぜ今届けるかを先に固定します。leader は specialist を並列で全部動かすのではなく、まず調査を見て、そのあと媒体を決め、必要な specialist だけ次に動かします。\n\n## 調査ファースト\n- Research: 市場、顧客、チャネル仮説\n- Teardown: 競合との差別化\n- Data: 現在の反応やボトルネック\n- Media planner: 調査結果をもとに媒体を優先順位化\n\n## Chosen media\n- first lane: まず回す媒体を1つ選ぶ\n- why now: その媒体を先にやる理由\n- next-best lane: 今回は後ろに回すが、次点になる媒体\n- hold lanes: 後回しにする媒体\n\n## Lane decision memo\n- objective: この lane で何を前進させるか\n- proof: この lane を選ぶ根拠\n- blocker: 実行前に埋めるべき不足\n- kill rule: どの条件なら止めるか\n\n## Specialist dispatch packet\n- specialist: 次に動かす expert agent\n- reason: この媒体で必要な役割\n- exact input: 何を前提に動くか\n- deliverable: 下書き、投稿案、送信案、listing packet など\n- approval owner: 誰が承認するか\n- timing: 今すぐか、条件付きか\n- metric / stop rule: 成功と停止条件\n\n## Leader approval queue\n- packet: leader が確認する exact packet\n- approver: CMO leader または指定運用者\n- ready check: assets / connector / claim proof が揃っているか\n- release condition: 承認後に何を実行してよいか\n\n## Planned action table\n| order | lane | owner | exact artifact | connector path | trigger / timing | metric | stop rule |\n| --- | --- | --- | --- | --- | --- | --- | --- |\n| 1 | research-backed first lane | CMO leader | specialist dispatch packet | manual review | now | first qualified response | stop if proof is weak |\n| 2 | chosen channel execution | specialist + leader | draft or connector packet | approved connector only | after approval | channel conversion | stop if spam / low-signal |\n\n## 次アクション\n最初の媒体を1つに絞り、その媒体の specialist にだけ次の実行依頼を出してください。`
        : `# cmo team leader delivery\n\n${fallbackPrompt}\n\n## CMO decision\nFix who the message is for, what outcome it promises, and why now. The leader should not fire every specialist in parallel by default. Review research first, decide the media lane second, then dispatch only the next needed specialist.\n\n## Research first\n- Research: market, customer, and channel evidence.\n- Teardown: competitive differentiation.\n- Data: current bottleneck and response signals.\n- Media planner: rank media using the research layer.\n\n## Chosen media\n- first lane: the one media lane to run first\n- why now: why it deserves to go first\n- next-best lane: the fallback lane if the first one stalls\n- hold lanes: what should wait\n\n## Lane decision memo\n- objective: what this lane must move\n- proof: why this lane is justified now\n- blocker: what is still missing before execution\n- kill rule: what would stop the lane\n\n## Specialist dispatch packet\n- specialist: the next expert agent to move\n- reason: why that specialist is needed now\n- exact input: what context or constraint the specialist must inherit\n- deliverable: draft, post packet, send packet, listing packet, or automation spec\n- approval owner: who must sign off\n- timing: now or after a named condition\n- metric / stop rule: success and stop condition for this packet\n\n## Leader approval queue\n- packet: the exact packet the leader must review\n- approver: CMO leader or named operator\n- ready check: whether assets, connector access, and proof are ready\n- release condition: what may execute after approval\n\n## Planned action table\n| order | lane | owner | exact artifact | connector path | trigger / timing | metric | stop rule |\n| --- | --- | --- | --- | --- | --- | --- | --- |\n| 1 | research-backed first lane | CMO leader | specialist dispatch packet | manual review | now | first qualified response | stop if proof is weak |\n| 2 | chosen channel execution | specialist + leader | draft or connector packet | approved connector only | after approval | channel conversion | stop if spam / low-signal |\n\n## Next action\nPick one first media lane from the research layer, then dispatch only that specialist next.`
    },
    cto_leader: {
      ...
      report: {
        ...
        bullets: [
          isJapanese ? '技術方針、実装範囲、リスク、検証を整理' : 'Clarify technical direction, implementation scope, risks, and validation.',
          isJapanese ? '開発/運用/セキュリティ/QAの責任境界を定義' : 'Define ownership across engineering, ops, security, and QA.',
          isJapanese ? '小さく安全に出す順番を決める' : 'Choose the smallest safe rollout sequence.'
        ],
        nextAction: isJapanese ? '書き込み範囲、テスト、ロールバック条件を確認してから実装に進んでください。' : 'Confirm write scope, tests, and rollback criteria before implementation.'
      },
      usage: { total_cost_basis: 92, compute_cost: 30, tool_cost: 16, labor_cost: 46, api_cost: 0 },
      markdown: isJapanese
        ? `# cto team leader delivery\n\n${fallbackPrompt}\n\n## CTO判断\nまずアーキテクチャ、変更範囲、失敗時の戻し方を決めます。\n\n## 分担\n- Code: 実装\n- Debug: 原因調査\n- Ops: デプロイ/設定\n- Security: 秘密情報、権限、入力境界\n- QA: 回帰テスト\n\n## 次アクション\n最小の安全な差分に切り、テストが通ることを完了条件にします。`
        : `# cto team leader delivery\n\n${fallbackPrompt}\n\n## CTO decision\nDecide architecture, change scope, and rollback before implementation.\n\n## Work split\n- Code: implementation.\n- Debug: root-cause analysis.\n- Ops: deploy and configuration.\n- Security: secrets, permissions, and input boundaries.\n- QA: regression tests.\n\n## Next action\nCut the smallest safe patch and require tests before completion.`
    },
    cpo_leader: {
    ...
    diligence: {
      ...
      report: {
        ...
        bullets: [
          isJapanese ? '強みと懸念を分離' : 'Separate positives from red flags.',
          isJapanese ? '未確認事項を明示' : 'Make the unknowns explicit.',
          isJapanese ? '次に確認すべき論点を決める' : 'Define the next diligence questions.'
        ],
        nextAction: isJapanese ? '赤旗から順に追加確認し、判断材料を増やす' : 'Follow up on the red flags first, then update the decision memo.'
      },
      usage: { total_cost_basis: 86, compute_cost: 22, tool_cost: 16, labor_cost: 48, api_cost: 0 },
      markdown: isJapanese
        ? `# due diligence delivery\n\n${fallbackPrompt}\n\n- 強みと懸念を分離\n- 未確認事項を明示\n- 次に確認すべき論点を決める`
        : `# due diligence delivery\n\n${fallbackPrompt}\n\n- Separate positives from red flags\n- Make the unknowns explicit\n- Define the next diligence questions`
    },
    earnings: {
    ...
    files: [
      {
        ...
        type: 'text/markdown',
        content: withDeliveryQualityMarkdown(
          kind,
...
function reviewPayload(kind, body = {}, plan = {}, draft = {}) {
  return {
    request: payloadInput(kind, body),
    plan,
    draft,
...
async function callOpenAi(kind, body, source = {}) {
  ...
  const draftResult = await callOpenAiStructured(config, {
    model,
    ...
    options: structuredRequestOptions(kind, body)
  });
  ...
  try {
    const reviewResult = await callOpenAiStructured(config, {
      ...
      schema: BUILT_IN_RESULT_SCHEMA,
      payload: reviewPayload(kind, body, plan, draft)
    });
