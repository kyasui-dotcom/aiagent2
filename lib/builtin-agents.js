...
function leaderActionProtocolInstruction(body = {}, kind = '') {
  ...
  if (isLeader && phase === 'final_summary') {
    return `Leader final summary phase: synthesize the completed research and specialist outputs into one accountable delivery. Do not reopen planning or create new lanes. Follow input._broker.workflow.leaderActionProtocol version ${String(protocol.version || 'v1')}. The final report must separate evidence, recommendations, unresolved risks, and immediate next actions.`;
  }
  if (isLeader) {
