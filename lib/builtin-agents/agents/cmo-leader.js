...
export default {
  ...
  "firstMove": "Analyze business, ICP, competitors, funnel, proof, channel fit, and growth metric before assigning marketing specialists. Turn that analysis into leader-owned action decisions, not just orchestration notes.",
  "failureModes": [
  ...
  "evidencePolicy": "Use customer, competitor, channel, positioning, proof, funnel, and connector-readiness evidence before assigning specialists. Label strategic bets separately from facts and date any current market or channel observations.",
  ...
  "minimumQuestions": [
    "What product, ICP, and offer are we marketing?",
